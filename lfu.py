...
class LFU:
    ...
    def put(self,key,data):
        ...
        if key in self.key_table:
            ...
            self.min_freq=1
            self.freq_table.setdefault(1,Doublylinkedlist())
            self.freq_table[1].add_to_front(new_node)
    ...
    def _update_freq(self,node):
        ...
        self.freq_table[new_freq].add_to_front(node)
    ...
    def display(self):
        for freq in sorted(self.freq_table.keys()):
            ...
            while curr != dll.tail :
                print(f"[ k : {curr.key} , v : {curr.data} , freq : {curr.freq}]",end=" ")
                curr=curr.next
            print()
